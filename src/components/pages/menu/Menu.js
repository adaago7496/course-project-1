        ...
        return(
            <div>
                ...
                <ul className="content">                
                        <li><Link to={{pathname: "../components/pages/cart/Checkout"}}><img alt="cheese" src={cheese} onClick={addToOrder("Cheese")}/>Cheese Pizza: {localStorage.getItem("Cheese")}</Link></li>
